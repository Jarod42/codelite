...
//------------------------------------------------------------
// Destructor
swStringSet::~swStringSet() { DeleteAll(); }
...
// string database
//------------------------------------------------------------
swStringDb::swStringDb() { m_compress = false; }
...
//------------------------------------------------------------
void swStringDb::DeleteSnippetKey(const wxString& key) { m_snippetSet.DeleteKey(key); }
//------------------------------------------------------------
void swStringDb::GetAllSnippetKeys(wxArrayString& keys) { m_snippetSet.GetAllKeys(keys); }
//------------------------------------------------------------
wxString swStringDb::GetSnippetString(const wxString& key) { return m_snippetSet.GetString(key); }
//------------------------------------------------------------
bool swStringDb::IsSnippetKey(const wxString& key) { return m_snippetSet.IsKey(key); }
//------------------------------------------------------------
