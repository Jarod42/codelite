...
TEST_CASE("text_cxx_assignment_from_global_method")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("text_code_completion_manager_cc")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("text_cxx_cc_with_problematic_typedef")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_complete_macro")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_complete_member_of_parent_class")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("TestCTagsManager_AutoCandidates")
{
    ENSURE_DB_LOADED();
    {
        vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_both_subscript_and_arrow_operator")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_anonymous_namespace")
{
    ENSURE_DB_LOADED();
    {
        wxString filepath;
...
TEST_CASE("test_cxx_code_completion_static_member")
{
    wxString filepath;
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_wxwindow")
{
    ENSURE_DB_LOADED();
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_wxwindow_get_event_handler")
{
    ENSURE_DB_LOADED();
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_overloaded_function")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_func_returning_unique_ptr_into_auto")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_template_inheritance")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_init_from_ctor")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_inheritance_children")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
...
TEST_CASE("test_cxx_code_completion_arrow_operator")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_subscript_operator")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_lsp_location_locals")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
...
TEST_CASE("test_cxx_code_completion_word_completion_externvar")
{
    ENSURE_DB_LOADED();
    {
        CxxRemainder remainder;
...
TEST_CASE("test_cxx_code_completion_word_completion")
{
    ENSURE_DB_LOADED();
    {
        CxxRemainder remainder;
...
TEST_CASE("test_cxx_word_completion_inside_scope")
{
    ENSURE_DB_LOADED();
    wxString filename;
    wxString filename_2;
...
TEST_CASE("test_cxx_code_completion_macros")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
    {
...
TEST_CASE("test_cxx_code_completion_c_style_enum")
{
    ENSURE_DB_LOADED();
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_casting")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_class_enum")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_this_and_global_scope")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_vector_of_pairs")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
...
TEST_CASE("test_cxx_code_completion_pointer_type_in_template")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
...
TEST_CASE("test_cxx_code_completion_invalid_completions")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_word_complete_cenum")
{
    ENSURE_DB_LOADED();
    CxxRemainder remainder;
    vector<TagEntryPtr> candidates;
...
TEST_CASE("test_cxx_code_completion_global_method")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_after_adding_func_impl")
{
    ENSURE_DB_LOADED();
    // use a line inside CxxCodeCompletion file
    wxString filename;
...
TEST_CASE("test_cxx_code_completion_member_variable_in_scope")
{
    ENSURE_DB_LOADED();
    // use a line inside CxxCodeCompletion file
    wxString filename;
...
TEST_CASE("test_cxx_code_completion_list_locals")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_full_ns_path")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_function_arguments")
{
    ENSURE_DB_LOADED();
    wxString filepath;
    wxString filepath2;
...
TEST_CASE("test_cxx_code_completion_rvalue_reference")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_member_variable")
{
    ENSURE_DB_LOADED();
    {
        wxString text = "TagEntry entry;";
...
TEST_CASE("test_cxx_code_completion_template_function")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_template_std_set")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_template_std_multiset")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_template_std_unordered_multiset")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_template_std_map")
{
    ENSURE_DB_LOADED();
    {
...
TEST_CASE("test_cxx_code_completion_typedef_using")
{
    ENSURE_DB_LOADED();
...
TEST_CASE("test_cxx_code_completion_template")
{
    ENSURE_DB_LOADED();
#if 0
    {
...
TEST_CASE("test_cxx_code_completion")
{
    ENSURE_DB_LOADED();
