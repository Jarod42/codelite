...
local function UseAsio()
	externalincludedirs { "submodules/asio/asio/include" }
end
-- ----------------------------------------------------------------------------
	project "assistant"
		kind "StaticLib"
		files { "submodules/assistant/ollama/**.*" }
...
-- ----------------------------------------------------------------------------
	project "WebTools"
		kind "SharedLib"
		files { "WebTools/**.*" }
		includedirs { "WebTools" }
		UsePlugin()

		filter "files:WebTools/XML/XMLLexer.l"
			flex_command("xml")
